...
<div class="Context">
    <div class="LeftMenu">
        <ul>
            ...
            <a href="../showprogress.php"><li class="HintAnimation">Πρόοδος αιτημάτων</li></a>
    ...
    <div class="MainMenu" style="background: none;">
        <div class="StartMessage">
            Η εισαγωγή της ερώτησης ολοκληρώθηκε με επιτυχία , θα ενημερωθείτε <br>
            για την πορεία της έγρισης της το συντομότερο δυνατόν<br>
            <form class="NextStep" action="../../panel.php"><button type="submit">Επιστροφή στο αρχικό μενού!</button></form>
        </div>
    </div>
</div>
