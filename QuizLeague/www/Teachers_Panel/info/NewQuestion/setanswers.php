...
<div class="Context">
    ...
    <div class="MainMenu" style="background: none;">
        <?php
            $file_list = (array)json_decode(file_get_contents('../../../../config/question_types.json'));
            include  $file_list['TYPE_'.$_SESSION['question_type_id']];
            $NewAnswers = new DefineNewAnswers();
