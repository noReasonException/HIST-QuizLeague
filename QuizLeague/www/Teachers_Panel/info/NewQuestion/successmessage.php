...
<div class="Context">
    ...
    <div class="MainMenu" style="background: none;">
        <div class="StartMessage">
            Η εισαγωγή της ερώτησης σας στο σύστημα ολοκληρώθηκε επιτυχώς <br>
            Σειρά έχει η εισαγωγή των απαντήσεων..<br>
            <form class="NextStep" action="setanswers.php"><button type="submit">Ας ξεκινήσουμε!</button></form>
        </div>
    </div>
</div>
