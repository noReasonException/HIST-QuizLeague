...
<div class="Context">
    <div class="LeftMenu">
        <ul>
            ...
            <a href="about.php"><li style="background-color:#7ca593;color:#ffffff;" >Περί...</li></a>
        </ul>

    </div>
    <div class="MainMenu" style="background: none;">
        <div class="About">
        <div class ="About_Name">QuizLeague Teachers<div style="font-size:15px;display:inline;">©</div> <br></div>
        <ul>
            <li>Βάσική έκδοση Dashboard : 0.0.1(Alpha Version) </li>
            <li>Έκδοση Βασικού Service  : 2.0.0 Magda(Alpha Version) </li>
         <li>Έκδοση Εφαρμογής Android: 1.0.0(Alpha Version) </li>
        </ul>
        <div class="CopyrightText_AboutMe">Quizleague © 2016-2017 Απο την Athens Coding Scene , Όλα τα δικαιώματα κρατούνται... </div>
    </div></div>
